...
class IceCreamView: UIView {
  ...
  override func draw(_ frame: CGRect) {
    ...
    let iceCreamGradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [iceCreamTopColor.cgColor, iceCreamBottomColor.cgColor] as CFArray, locations: [0, 1])!
